...
const value = sum
// * 변수에 함수 본문을 할당할 수 있고 이렇게 하면 변수가 함수가 되어 실행할 수 있게됨
...
const result = first() // first()() 이렇게 실행할 수도 있음. 함수의 커링 (currying function)
// closure = 밖에 있는 변수 result가 중첩 함수의 내부함수의 역할을 하게 만들어주는 형태.
result(30)
...
// double(3) = 6 -> 2 * 3
const triple = multi(3)// triple(4) = 12 -> 3 * 4
