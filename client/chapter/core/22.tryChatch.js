...
// * JSON : JavaScript Object Notation -> 자바스크립트에서 쓰는 객체 표기법을 비슷하게 가져다 쓰는 데이터 형태
...
console.log(user.value) // 이렇게 하면 에러가 발생하는 게 아니라 undefined가 반환되기 때문에 밑의 조건을 추가해주기
...
if(!user.value){
    ...
    document.body.insertAdjacentHTML = '404 not found >-<' // -> 에러 시 사용자에게 보여줄 설명을 임의로 넣어줄 수도 있음
}
