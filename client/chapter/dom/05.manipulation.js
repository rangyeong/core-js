...
const div = document.createElement('div'); // 태그처럼보이는 객체 생성.

div.className = 'text-box';
div.textContent = '본문 시작'; //document.write대신 쓰는 텍스트 삽입 메서드
