...
console.log(first.nodeType === document.ELMENT_NODE )
//                                  ⬆️ 이 부분에 mdn nodeType 파일 보고 숫자 넣어줘서 조건 만들기 
console.log(first.nodeType === 1) // true

console.log(first.nodeName)
console.log(first.tagName) // first가 태그라서 해당 메서드를 사용할 수 있는 것.
// nodeName = (텍스트나 코멘트 등등) 다른 요소의 이름도 수집.
// tagName =  태그들만 수집. 나머지 언디파인드가 반환
...
console.log(first.textContent); // hello안녕 멋쟁이!
...
gsap.to('h1',{
    opacity:0,
    duration:0.5,
    repeat: -1, // 음수는 nagative infinity 무한 반복
    yoyo:true, // 자연스럽게 만들기
})
